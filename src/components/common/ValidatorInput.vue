<template>
  <label class="va_ipt " v-bind:class="[btnClear && inputValue?'has_opt':'']" style="width:100%">
    ...
    <mu-text-field v-else :hintText="hintText" @focus="changeKeyBoard(true)" @blur="changeKeyBoard(false)" :errorText="errorMsg||errorText" :type="type" :disabled="disabled" :label="label" v-model="inputValue" multiLine :rows="1.5" :rowsMax="2" /><br/>
